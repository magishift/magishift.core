...
import { IKeycloakService } from './interfaces/keycloakAdminService.interface';
...
export class KeycloakService implements IKeycloakService {
  ...
  constructor(private readonly httpService: HttpService, private readonly redisService: RedisService) {
    ...
    const masterConfig = this.realmConfigs.master;
    masterConfig.authServerUrl = this.realmConfigs.master.authServerUrl || this.defaultAuthServerUrl;
