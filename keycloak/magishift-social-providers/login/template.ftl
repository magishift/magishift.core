...
<head>
    ...
    <title><#nested "title"> - ${realm.displayName!'MAGISHIFT'}</title>

    <#-- Start MAGISHIFT Template <head> content -->

    <!--[if gt IE 8]><!--><link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/magishift-template.css?0.22.1" media="screen" rel="stylesheet" /><!--<![endif]-->
    <!--[if IE 6]><link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/magishift-template-ie6.css?0.22.1" media="screen" rel="stylesheet" /><![endif]-->
    <!--[if IE 7]><link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/magishift-template-ie7.css?0.22.1" media="screen" rel="stylesheet" /><![endif]-->
    <!--[if IE 8]><link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/magishift-template-ie8.css?0.22.1" media="screen" rel="stylesheet" /><![endif]-->
    <link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/magishift-template-print.css?0.22.1" media="print" rel="stylesheet" />
    ...
    <#-- End MAGISHIFT Template <head> content -->


    <#-- MAGISHIFT Elements stylesheets -->
    ...
    <#-- End MAGISHIFT Elements stylesheets -->
...
<body class="${properties.kcBodyClass!}">
    <#-- Add MAGISHIFT Template <body> JavaScript class -->
    <script>document.body.className = ((document.body.className) ? document.body.className + ' js-enabled' : 'js-enabled');</script>


    <#-- Start MAGISHIFT Template header -->
    ...
    <div id="global-cookie-message">
        ...
        <p>MAGISHIFT uses cookies to make the site simpler. <a href=\"https://www.gov.uk/help/cookies\">Find out more about cookies</a></p>
      ...
      <div class="header-wrapper">
        <div class="header-global">
          <div class="header-logo">
            <a href="https://www.gov.uk" title="Go to the MAGISHIFT homepage" id="logo" class="content">
              <img src="${url.resourcesPath}/vendor/govuk_template/images/gov.uk_logotype_crown_invert_trans.png?0.22.1" width="36" height="32" alt=""> MAGISHIFT
            </a>
          </div>
        </div>
    ...
    <main id="content" role="main">
        ...
        <div class="grid-row">
            <div class="column-two-thirds">
                ...
                <#-- The MAGISHIFT Template is not designed for custom logos, so remove the Keycloak template’s logo HTML -->
                <#-- <div id="kc-logo"><a href="${properties.kcLogoLink!'#'}"><div id="kc-logo-wrapper"></div></a></div> -->

                <div id="kc-container" class="${properties.kcContainerClass!}">
                    <div id="kc-container-wrapper" class="${properties.kcContainerWrapperClass!}">

                        <#-- The MAGISHIFT Template header is included above, with Keycloak’s nested header section inside it, so remove the Keycloak template’s header HTML -->
    ...
    <#-- Start MAGISHIFT Template footer -->
    ...
    <script src="${url.resourcesPath}/vendor/govuk_template/javascripts/magishift-template.js?0.22.1"></script>

    <script>if (typeof window.GOVUK === 'undefined') document.body.className = document.body.className.replace('js-enabled', '');</script>

    <#-- End MAGISHIFT Template footer -->
